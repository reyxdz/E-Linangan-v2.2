// Fullscreen handler for pangwakasPagsusulit
(function () {
    'use strict';
    ...
    if (fsConfirmExit) {
        fsConfirmExit.addEventListener('click', function () {
            // User confirmed exit: redirect to pambungad
            hideExitModal();
    ...
    // Initialize immediately when script loads to enter fullscreen as soon as possible
